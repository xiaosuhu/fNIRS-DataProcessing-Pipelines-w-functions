function [onelinestructure, cellarraystructure] = StructureFinding(mni, DB, orig)
% function [onelinestructure, cellarraystructure] = StructureFinding(mni, DB)
%
...
%
%   Example:
%   StructureFinding([72 -34 -2; 50 22 0], DB)
%
% Xu Cui
% 2007-11-20
% Modified by Xiaosu Hu Oct 30 2018
