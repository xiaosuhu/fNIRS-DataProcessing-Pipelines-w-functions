function Plot3D_channel_registration_result_Ver2021(intensity, MNIcoord, MNIcoordstd,mx,mn,colorscheme,brain_vol)
...
intensity_0 = round((intensity_0 - mn)/(mx - mn) * 255 + 1);
intensity_1 = round((intensity_1 - mn*scale1)/(mx*scale1 - mn*scale1) * 255 + 1);
intensity_2 = round((intensity_2 - mn*scale2)/(mx*scale2 - mn*scale2) * 255 + 1);
intensity_3 = round((intensity_3 - mn*scale3)/(mx*scale3 - mn*scale3) * 255 + 1);
intensity_4 = round((intensity_4 - mn*scale4)/(mx*scale4 - mn*scale4) * 255 + 1);
